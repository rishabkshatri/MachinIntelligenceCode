...
class SVM:
    ...
    def __init__(self, dataset_path):
        ...
        Given_data = pd.read_csv(self.dataset_path)
...
class SVM:
    ...
    def solve(self):
        ...
        return Pipeline([('standard_scalar', StandardScaler()),('svc', SVC(C=5))]).fit(self.X, self.y)


        self.X = Given_data.iloc[:, :-1]
        # y-> Contains all the targets
        self.y = Given_data.iloc[:, -1]
    ...
    def solve(self):
        ...
        return Pipeline([('standard_scalar', StandardScaler()), ('normalizer', Normalizer()),('svc', SVC(C=1.5))]).fit(self.X, self.y)
